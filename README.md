...
**Задача:** Бинарная классификация фрод/нефрод на основе транзакционной активности в блокчейне

**Датасет:** [Транзакционная активность с пометками о фроде](https://www.kaggle.com/datasets/vagifa/ethereum-frauddetection-dataset)
